...
main = do
	...
	putStrLn (show (testPossibleUpdate matrix (matrixLength matrix) 4 0))
	--putStrLn ("New matrix = " ++ (show (matrixUpdate matrix (matrixLength matrix) 1 5)))
